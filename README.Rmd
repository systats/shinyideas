...
This is a collection of learning materials and code snippets to get your shiny app to the next levels. We will dive into 
...
* Extensions:
    ...
    - [`shinyuser`](https://github.com/systats/shinyuser) login and user managment tools
* Tools:
...
Like on CRAN you can load and download any serious web package from static servers: 
